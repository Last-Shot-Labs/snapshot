...
export declare const RouteStateDefinitionsContext: import("react").Context<SharedStateConfigMap>;
export declare const AppStateDefinitionsContext: import("react").Context<SharedStateConfigMap>;
