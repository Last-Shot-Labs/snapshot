...
import { generateTsConfigRoot, generateTsConfigApp, generateTsConfigNode } from './templates/tsconfig'
...
`
  ...
  if (config.communityPages) {
    await write('src/pages/community/CommunityContainersPage.tsx', generateCommunityContainersPageComponent())
    await write('src/pages/community/CommunityThreadListPage.tsx', generateCommunityThreadListPageComponent())
    await write('src/pages/community/CommunityThreadPage.tsx', generateCommunityThreadPageComponent())
    await write('src/routes/_authenticated/community/index.tsx', generateCommunityContainersRoute())
    await write('src/routes/_authenticated/community/$containerId.tsx', generateCommunityThreadListRoute())
    await write('src/routes/_authenticated/community/$containerId.$threadId.tsx', generateCommunityThreadRoute())
  }
