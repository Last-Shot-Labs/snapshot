...
export default class Init extends Command {
  ...
  static override flags = {
    yes:      Flags.boolean({ char: 'y', description: 'Skip prompts, use defaults' }),
  ...
  async run(): Promise<void> {
    ...
    const wsLine = config.webSocket ? `    VITE_WS_URL       — full WebSocket endpoint URL (e.g. ws://host/chat)\n` : ''
