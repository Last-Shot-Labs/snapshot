...
export function createCommunityHooks({ api, queryClient: _qc }: { api: ApiClient; queryClient: QueryClient }) {
  ...
  function useUpdateContainer() {
    ...
    return useMutation<ContainerResponse, ApiError, { containerId: string } & UpdateContainerBody>({
      ...
      onSuccess: (_data, { containerId }) => {
        void queryClient.invalidateQueries({ queryKey: keys.containers() })
        void queryClient.invalidateQueries({ queryKey: keys.container(containerId) })
      },
    })
  }
  ...
  function useUpdateThread() {
    const queryClient = useQueryClient()
    return useMutation<ThreadResponse, ApiError, { threadId: string; containerId: string } & UpdateThreadBody>({
  ...
  function useCreateReply() {
    ...
    return useMutation<ReplyResponse, ApiError, { threadId: string } & CreateReplyBody>({
      ...
      onSuccess: (_data, { threadId }) => {
        void queryClient.invalidateQueries({ queryKey: keys.replies(threadId) })
  ...
  function useUpdateReply() {
    const queryClient = useQueryClient()
    return useMutation<ReplyResponse, ApiError, { replyId: string; threadId: string } & UpdateReplyBody>({
      ...
      onSuccess: (_data, { replyId, threadId }) => {
        void queryClient.invalidateQueries({ queryKey: keys.replyDetail(replyId) })
        void queryClient.invalidateQueries({ queryKey: keys.replies(threadId) })
        void queryClient.invalidateQueries({ queryKey: keys.searchReplies() })
      },
    })
  ...
  function useAddMember() {
    ...
    return useMutation<void, ApiError, { containerId: string; userId: string }>({
      ...
      onSuccess: (_data, { containerId }) => {
        void queryClient.invalidateQueries({ queryKey: keys.members(containerId) })
      },
    })
  }
  ...
  function useAssignModerator() {
    ...
    return useMutation<void, ApiError, { containerId: string; userId: string }>({
      ...
      onSuccess: (_data, { containerId }) => {
        void queryClient.invalidateQueries({ queryKey: keys.moderators(containerId) })
      },
    })
  }
  ...
  function useAssignOwner() {
    ...
    return useMutation<void, ApiError, { containerId: string; userId: string }>({
      ...
      onSuccess: (_data, { containerId }) => {
        void queryClient.invalidateQueries({ queryKey: keys.owners(containerId) })
      },
    })
  }
  ...
  function useCreateBan() {
    ...
    return useMutation<BanResponse, ApiError, BanBody>({
      ...
      onSuccess: (_data, { userId }) => {
        ...
        void queryClient.invalidateQueries({ queryKey: keys.banCheckPrefix(userId) })
      },
    })
  }
