...
describe('formatAuthError', () => {
  ...
  it('returns default safe message per context on non-localhost', () => {
    ...
    expect(formatAuthError(err, 'reset-password')).toBe('Unable to reset password. The link may have expired.')
  ...
  it('custom messages override defaults', () => {
    ...
    expect(formatAuthError(err, 'register', config)).toBe('Unable to create account. Please try again.')
  })
